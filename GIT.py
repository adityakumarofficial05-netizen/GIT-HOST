...
# --- Configuration ---
TOKEN = '8770968022:AAEfXwUHKmO1k_83dQiQUCSvToD_bzvzc3c'
OWNER_ID = 8360629421
ADMIN_ID =  8360629421
YOUR_USERNAME = '@CUREENTTT'
...
def _process_github_download(chat_id, user_id):
    ...
    time.sleep(1)
    bot.edit_message_text(stylish_text("🔗 𝐑𝐄??𝐎 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐈𝐎𝐍...\n\n[▓▓▓░░░░░░░] 30%"), chat_id, msg.message_id)
    time.sleep(1)
...
def create_main_menu_inline(user_id):
    ...
    if user_id in admin_ids:
        admin_buttons = [
            types.InlineKeyboardButton('?? ??𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧𝐬', callback_data='subscription'),
...
def _logic_updates_channel(message):
    ...
    markup = types.InlineKeyboardMarkup(row_width=1)
    markup.add(
        types.InlineKeyboardButton("ADITYA_APIS TELEGRAM TEAM", url="https://t.me/Adityaapis_570")
    )
